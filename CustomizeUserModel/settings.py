...
SECRET_KEY = 'django-insecure-mx9afy-#^t)b$jhkql=l(@=_#x$t73ph!e76dojhyp@%lok($#'
...
ROOT_URLCONF = 'CustomizeUserModel.urls'
...
WSGI_APPLICATION = 'CustomizeUserModel.wsgi.application'
